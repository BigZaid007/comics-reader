...
class MarvelScreen extends StatefulWidget {
  ...
  const MarvelScreen({super.key, required this.app});

  @override
  State<MarvelScreen> createState() => _MarvelScreennState();
}

class _MarvelScreennState extends State<MarvelScreen> {
  ...
  void initState() {
    ...
    _comics = _database!.ref().child('Marvel');
  }
    ...
    return Container(
        ...
        decoration: BoxDecoration(
            image: DecorationImage(
                image: AssetImage('assets/images/marve-heros.jpg'))),
        child: Scaffold(
          appBar: AppBar(
                ...
                Align(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.symmetric(
                        ...
                        .r,
                    child: Text(
                      'Embark on Marvel Universe Epics!',
